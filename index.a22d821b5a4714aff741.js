...
;// CONCATENATED MODULE: ./src/scripts/blocks/anchorSmoothScroll.js
...
;// CONCATENATED MODULE: ./src/scripts/blocks/btnToTop.js
function btnToTop() {
...
function slider() {
  ...
  function swiperServicesInit() {
    var swiperServices = new core(".services-swiper", {
      pagination: {
  ...
  ;
  function swiperInstrumentsInit() {
    var swiperInstruments = new core(".instruments-swiper", {
      pagination: {
  ...
  function detectDeviceIn() {
    if (/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)) {
      swiperInstrumentsInit();
    } else {}
  }
  detectDeviceIn();
  detectDevice();
...
function burger() {
  ...
  var mediaLink = document.querySelectorAll('.media-link');
...
;// CONCATENATED MODULE: ./src/scripts/blocks/preloader.js
function preloader() {
